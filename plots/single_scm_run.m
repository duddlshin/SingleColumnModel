...
%  ------------------------------------------------------------------------
%  Purpose
%    Generate profile and time-series figures for a scm run.
...
%    Derived arrays    : wsph_mn, wdir_mn, vmf_mn, l_m
%
%  Output
%    A single figure with profiles and time series.
%
%  Usage
%    % after running main/scm_run:
%    run('plots/scm_plot.m')
%
%  Notes
...
ax(5) = nexttile;  
plot(avgVars.wT_mn, z, 'Color', c1, 'LineWidth',1.5);
