function settings = namelist_tnbl()
%NAMELISTS.NAMELIST_TNBL  Settings for the TNBL case.

settings = struct();

% Case
settings.casename = "tnbl";                                                % Problem case
...
% Domain
settings.Lz = 5000;                                                        % Domain height [m]   
...
% Physics
settings.Gx = 12;                                                          % Geostrophic wind u-component [m/s]   
settings.Gy = 0;                                                           % Geostrophic wind v-component [m/s]
settings.phi = 70;                                                         % Latitude [deg]
